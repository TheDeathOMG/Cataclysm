...
public class IgnatiusModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Pierna2 = Piernas.addOrReplaceChild("Pierna2", CubeListBuilder.create().texOffs(79, 30).addBox(-1.0F, 11.0F, -5.0F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(36, 35).addBox(-1.0F, 4.0F, -4.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, -12.0F, 0.0F));

		PartDefinition Muslo2_r1 = Pierna2.addOrReplaceChild("Muslo2_r1", CubeListBuilder.create().texOffs(70, 83).addBox(-1.8398F, -5.949F, -3.1883F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, 0.0F, -0.2597F, -0.0338F, -0.1265F));

		PartDefinition Gemelo2_r1 = Pierna2.addOrReplaceChild("Gemelo2_r1", CubeListBuilder.create().texOffs(36, 43).addBox(-1.0F, -3.658F, -1.0603F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, -1.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition Pierna1 = Piernas.addOrReplaceChild("Pierna1", CubeListBuilder.create().texOffs(36, 35).mirror().addBox(-3.0F, 4.0F, -4.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(79, 30).mirror().addBox(-3.0F, 11.0F, -5.0F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, -12.0F, 0.0F));

		PartDefinition Gemelo1_r1 = Pierna1.addOrReplaceChild("Gemelo1_r1", CubeListBuilder.create().texOffs(36, 43).mirror().addBox(-3.0F, -3.658F, -1.0603F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 11.0F, -1.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition Muslo1_r1 = Pierna1.addOrReplaceChild("Muslo1_r1", CubeListBuilder.create().texOffs(70, 83).mirror().addBox(-2.1602F, -5.949F, -3.1883F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 5.0F, 0.0F, -0.2597F, 0.0338F, 0.1265F));
		...
		PartDefinition Cara_r1 = Cabezacuello.addOrReplaceChild("Cara_r1", CubeListBuilder.create().texOffs(50, 63).addBox(-3.0F, -10.0F, -4.0F, 7.0F, 9.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(44, 43).addBox(-4.0F, -11.0F, -5.0F, 9.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, 1.0F, 0.0F, 0.829F, 0.0F));

		PartDefinition Brazos = Resto.addOrReplaceChild("Brazos", CubeListBuilder.create(), PartPose.offset(0.0F, -35.0F, 0.0F));

		PartDefinition AnteMano2 = Brazos.addOrReplaceChild("AnteMano2", CubeListBuilder.create(), PartPose.offsetAndRotation(16.0F, 0.0F, -7.0F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition AnteMano1 = Brazos.addOrReplaceChild("AnteMano1", CubeListBuilder.create(), PartPose.offsetAndRotation(-16.0F, 1.0F, -7.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition Hombro1_r1 = AnteMano1.addOrReplaceChild("Hombro1_r1", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-4.0F, -5.6897F, -4.5091F, 9.0F, 10.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.0F, -3.0F, 2.0F, -0.6545F, 0.0F, 0.0F));

		PartDefinition Biceps1_r1 = AnteMano1.addOrReplaceChild("Biceps1_r1", CubeListBuilder.create().texOffs(50, 79).mirror().addBox(-3.0347F, -4.8444F, -1.7233F, 5.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.0203F, -1.8458F, -0.1705F, 0.0376F, 0.215F));

		PartDefinition Codo1_r1 = AnteMano1.addOrReplaceChild("Codo1_r1", CubeListBuilder.create().texOffs(0, 77).mirror().addBox(-1.7397F, -2.2065F, -2.8356F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 6.0203F, -2.8458F, 0.5559F, -0.4681F, 0.3588F));

		PartDefinition Antebrazo1_r1 = AnteMano1.addOrReplaceChild("Antebrazo1_r1", CubeListBuilder.create().texOffs(68, 69).mirror().addBox(-1.0F, 1.0F, -5.0F, 4.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 8.0203F, -9.8458F, 0.5273F, -0.1133F, -0.0657F));

		PartDefinition Espada = AnteMano1.addOrReplaceChild("Espada", CubeListBuilder.create(), PartPose.offset(1.0F, 15.0203F, -12.8458F));

		PartDefinition Mano1_r1 = Espada.addOrReplaceChild("Mano1_r1", CubeListBuilder.create().texOffs(58, 30).mirror().addBox(-3.6256F, -3.3562F, -3.349F, 7.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.2739F, 0.4987F, -1.3983F));
